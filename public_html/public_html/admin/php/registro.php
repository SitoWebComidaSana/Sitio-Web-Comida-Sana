...
if (!$ajax) {
	...
	$usu_sexo=$_POST["rd1"]; $usu_fecha_naciemiento = $_POST["fecha_nac"];	
	
		
	include_once('InstConexion.php');	$objeto = new  InstConexion();	$objeto->Conectar();
	$sql="INSERT INTO `u882124156_food`.`usuario` (`usu_nombre`, `usu_apellido`, `usu_correo`, `usu_clave`, `usu_estado`, `usu_motivo_registro`, `usu_sexo`, `usu_fecha_nacimiento`) 
VALUES ('".$usu_nombre."','".$usu_apellido."','".$usu_correo."','".$usu_clave."', 1, '".$usu_motivo_registro."', '".$usu_sexo."', '".$usu_fecha_naciemiento."')";
