...
-- Volcando estructura para tabla reservacion ESTA  TABLA AGREGUE
DROP TABLE IF EXISTS `reservacion_linea`;
CREATE TABLE IF NOT EXISTS `reservacion_linea` (
  `nombre_reservacion` varchar(50) NOT NULL,
  `email_reservacion` varchar(30) NOT NULL,
  `dir_reservacion` varchar(50) NOT NULL,
  `num_telf_reservacion` int(11) NOT NULL,
   `num_per_reservacion` int(11) NOT NULL,
  `descrip_reservacion` varchar(200) NOT NULL,
  `estado_reservacion` int(11) NOT NULL,
  PRIMARY KEY (`nombre_reservacion`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
